...
sed -i 's|^\([[:space:]]*\)\([^#][[:space:]]*./extra/extra.nix[[:space:]]*\)|\1# \2|' flake.nix
sed -i 's|^\([[:space:]]*\)\([^#][[:space:]]*./extra/torzu.nix[[:space:]]*\)|\1# \2|' flake.nix
sed -i 's|^\([[:space:]]*\)\([^#][[:space:]]*./extra/jellyfin.nix[[:space:]]*\)|\1# \2|' flake.nix
sed -i 's|^\([[:space:]]*\)\([^#][[:space:]]*./home-manager/lock.nix[[:space:]]*\)|\1# \2|' flake.nix
git add -u .
