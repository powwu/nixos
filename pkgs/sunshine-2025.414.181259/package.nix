...
in
  stdenv'.mkDerivation rec {
    pname = "sunshine";
    version = "2025.414.181259";

    src = fetchFromGitHub {
      owner = "LizardByte";
      repo = "Sunshine";
      rev = "57b5b296da60b07aaa11c517a071992beb19bb11";
      hash = "sha256-WDKo4kEIlNM1ghGIoT+x4nc63/0cHtrJjZHqwMML4kU=";
    ...
    ui = buildNpmPackage {
      inherit src version;
      pname = "sunshine-ui";
      npmDepsHash = "sha256-rc+zy1OO4YJC/GSk5pqzLd5d/9Jry423WD1f13iaO9U=";
